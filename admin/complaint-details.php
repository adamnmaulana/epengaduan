...
?>									
										<tr>
											<td><b>No Pengaduan</b></td>
											<td><?php echo htmlentities($row['complaintNumber']);?></td>
											<td><b>Nama Pengadu</b></td>
											<td> <?php echo htmlentities($row['name']);?></td>
											<td><b>Tanggal Aduan</b></td>
...
<tr>
											...
											<td ><b>Judul Pengaduan</b></td>
											<td colspan="3"> <?php echo htmlentities($row['noc']);?></td>
											
										</tr>
<tr>
											<td><b>Detail Pengaduan </b></td>
...
<a href="../users/complaintdocs/<?php echo htmlentities($row['complaintFile']);?>" target="_blank"/> Lihat File</a>
<?php } ?></td>
</tr>
...
<tr>
<td><b>Balasan</b></td>
<td colspan="5"><?php echo  htmlentities($rw['remark']); ?> <b>Balasan :</b><?php echo  htmlentities($rw['rdate']); ?></td>
</tr>
...
<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/eva/admin/updatecomplaint.php?cid=<?php echo htmlentities($row['complaintNumber']);?>');" title="Update order">
											 <button type="button" class="btn btn-primary">Ambil Aksi</button></td>
											</a><?php } ?></td>
											<td colspan="4"> 
											<a href="javascript:void(0);" onClick="popUpWindow('http://localhost/eva/admin/userprofile.php?uid=<?php echo htmlentities($row['userId']);?>');" title="Update order">
											 <button type="button" class="btn btn-primary">Lihat Detail Pengguna</button></a></td>
