...
<head>
	...
	<title>Admin| Atur Pengguna</title>
...
<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/eva/admin/userprofile.php?uid=<?php echo htmlentities($row['id']);?>');" title="View Details">
