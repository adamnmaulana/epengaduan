...
<head>
	...
	<title>Admin | Penerima Aduan </title>
...
<label class="control-label" for="basicinput">Nama Penerima Aduan</label>
<div class="controls">
<input type="text" placeholder="Masukan Nama Penerima Aduan"  name="state" class="span8 tip" required>
</div>
</div>
