...
<?php include('includes/sidebar.php');?>
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i>Detail  Pengaduan </h3>
            <hr />
...
{?>
          	<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Nomor Pengaduan : </b></label>
          		<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label"><b>Sub-Kateogri :</b> </label>
              <div class="col-sm-4">
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Tipe Pengaduan :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['complaintType']);?></p>
              </div>
<label class="col-sm-2 col-sm-2 control-label"><b>Penerima Aduan :</b></label>
              <div class="col-sm-4">
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Judul Pengaduan :</b></label>
              <div class="col-sm-4">
...
<a href="complaintdocs/<?php echo htmlentities($row['complaintFile']);?>" target='_blank'> Lihat File</a>
<?php } ?>
 ...
 <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Detail Pengaduan </label>
              <div class="col-sm-10">
...
<label class="col-sm-2 col-sm-2 control-label"><b>Balasan:</b></label>
              <div class="col-sm-10">
...
<label class="col-sm-2 col-sm-2 control-label"><b>Status AKhir :</b></label>
              <div class="col-sm-4">
              <p style="color:red"><?php 

if($row['status']=="NULL" || $row['status']=="" )
{
echo "Masih Belum diproses";
} else{
