...
<html lang="en">
  <head>
    ...
    <title>Pengaduan | Ubah Password</title>
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Ubah Password Pengguna</h4>
 ...
 <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                      ...
                      <form class="form-horizontal style-form" method="post" name="chngpwd" onSubmit="return valid();">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Password Sebelumnya</label>
                              <div class="col-sm-10">
...
<div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Ubah Password</label>
                              <div class="col-sm-10">
...
<div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Konfirm Password</label>
                              <div class="col-sm-10">
