...
{?>
					  			...
					  			<p><?php echo htmlentities($num1);?> Pengaduan masih belum diproses</p>
                  		</div>
                      <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Status pengaduan sedang diproses</p>
                      </div>
  <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Pengaduan telah selesai</p>
                      </div>
