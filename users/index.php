...
<html lang="en">
  <head>
    ...
    <title>Pengaduan | Login Pengguna</title>
	  ...
	  <div id="login-page">
	  	<div class="container">
		      ...
		      <form class="form-login" name="login" method="post">
		        <h2 class="form-login-heading"><b>Silahkan Masuk</h2>
		        <p style="padding-left:4%; padding-top:2%;  color:#003366">
		        	<?php if($errormsg){
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		            <input type="text" class="form-control" name="username" placeholder="ID User"  required autofocus>
		            <br>
		            ...
		            <button class="btn btn-theme btn-block" name="submit" type="submit"><i class="fa fa-lock"></i> Masuk</button>
		            <hr>
		           </form>
