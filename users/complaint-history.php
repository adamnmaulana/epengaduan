...
<html lang="en">
  <head>
    ...
    <title>Pengaduan | Histori Pengaduan </title>
...
<?php include("includes/sidebar.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Pengaduan Histori Anda</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                              ...
                              <tr>
                                 ...
                                 ?></td>
                                  <td align="center"><?php 
                                    ...
                                    { ?>
                                      <button type="button" class="btn btn-theme04">Masih Belum diproses</button>
                                   <?php }
