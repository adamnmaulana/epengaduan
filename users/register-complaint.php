     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Masukan Data Pengaduan Anda</h3>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Tipe Pengaduan</label>
<div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label">Penerima Aduan</label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label"> Judul Pengaduan </label>
<div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Detail Pengaduan (max 2000 kata) </label>
<div class="col-sm-6">
<textarea  name="complaindetails" required="required" cols="10" rows="10" class="form-control" maxlength="2000"></textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Dokumen Pengaduan (Jika Ada) </label>
<div class="col-sm-6">
